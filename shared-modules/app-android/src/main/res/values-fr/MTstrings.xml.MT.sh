...
<resources>
    <string name="app_name">MonTransit $AGENCY_NAME_SHORT $TYPE_LABEL ($LOCATION_LABEL)</string>
    <string name="app_desc">Données des $TYPE_LABEL de $AGENCY_NAME_LONG ($LOCATION_LABEL) pour MonTransit.</string>
</resources>
EOL
